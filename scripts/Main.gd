...
## The ocean grows WITH its apex: newcomers spawn at a rolled fraction of the current
## leader's size, so a giant is never left alone among minnows — there is always a
## rival worth fearing (and worth eating). Early game is untouched: the floor is the
